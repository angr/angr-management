...
ENTRIES = [
    ...
    CE('disasm_view_function_color',                   QColor, QColor(200,  200,  200)),
    CE('disasm_view_label_color',                      QColor, QColor(200,  200,  200)),
    ...
    CE('disasm_view_node_shadow_color',                QColor, QColor(0,    0,    0,      75)),
    ...
    CE('function_table_color',                         QColor, QColor(0xe0, 0xe0, 0xe0)),
    CE('function_table_syscall_color',                 QColor, QColor(0,    0,    0x80)),
    CE('function_table_plt_color',                     QColor, QColor(0,    0x80, 0)),
    CE('function_table_simprocedure_color',            QColor, QColor(0x80, 0,    0)),
    CE('function_table_alignment_color',               QColor, QColor(0x80, 0x80, 0)),
    CE('palette_window',                               QColor, QColor(239,  239,  239,    255)),
    CE('palette_windowtext',                           QColor, QColor(0,    0,    0,      255)),
    CE('palette_base',                                 QColor, QColor(255,  255,  255,    255)),
    CE('palette_alternatebase',                        QColor, QColor(247,  247,  247,    255)),
    CE('palette_tooltipbase',                          QColor, QColor(255,  255,  220,    255)),
    CE('palette_tooltiptext',                          QColor, QColor(0,    0,    0,      255)),
    CE('palette_text',                                 QColor, QColor(0,    0,    0,      255)),
    CE('palette_button',                               QColor, QColor(239,  239,  239,    255)),
    CE('palette_buttontext',                           QColor, QColor(0,    0,    0,      255)),
    CE('palette_brighttext',                           QColor, QColor(255,  255,  255,    255)),
    CE('palette_highlight',                            QColor, QColor(48,   140,  198,    255)),
    CE('palette_highlightedtext',                      QColor, QColor(255,  255,  255,    255)),
    CE('palette_disabled_text',                        QColor, QColor(190,  190,  190,    255)),
    CE('palette_disabled_buttontext',                  QColor, QColor(190,  190,  190,    255)),
    CE('palette_disabled_windowtext',                  QColor, QColor(190,  190,  190,    255)),
    CE('palette_light',                                QColor, QColor(255,  255,  255,    255)),
    CE('palette_midlight',                             QColor, QColor(202,  202,  202,    255)),
    CE('palette_dark',                                 QColor, QColor(159,  159,  159,    255)),
    CE('palette_mid',                                  QColor, QColor(184,  184,  184,    255)),
    CE('palette_shadow',                               QColor, QColor(118,  118,  118,    255)),
    CE('palette_link',                                 QColor, QColor(0,    0,    255,    255)),
    CE('palette_linkvisited',                          QColor, QColor(255, 0, 255, 255)),
