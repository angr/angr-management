...
class Instance:
    ...
    def __init__(self):
        ...
        self.register_container('log', lambda: [], List[LogRecord], 'Saved log messages', async_=True)
    ...
    def register_container(self, name, default_val_func, ty, description, *, async_: bool = False):
        if name in self.extra_containers:
            ...
            self.extra_containers[name] = ObjectContainer(default_val_func(), description, async_=async_)
