...
class AnalyzeMenu(Menu):
    def __init__(self, main_window):
        ...
        self.entries.extend(
            [
                MenuEntry("&Run Analysis...", main_window.run_analysis, shortcut=QKeySequence(Qt.Key_F4)),
                MenuSeparator(),
                MenuEntry("&Decompile", main_window.decompile_current_function, shortcut=QKeySequence(Qt.Key_F5)),
                MenuEntry(
