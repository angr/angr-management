...
class ViewMenu(Menu):
    def __init__(self, main_window):
        ...
        self.entries.extend([
            MenuEntry('Next Tab', main_window.nextTab, shortcut=QKeySequence("Ctrl+Tab")),
            MenuEntry('Previous Tab', main_window.previousTab, shortcut=QKeySequence("Ctrl+Shift+Tab")),
            MenuSeparator(),
